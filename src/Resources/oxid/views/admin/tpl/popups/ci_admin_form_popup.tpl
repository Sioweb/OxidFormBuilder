...
<script type="text/javascript">
    initAoc = function()
    {
        ...
        YAHOO.oxid.container1 = new YAHOO.oxid.aoc( 'container1',
                                                    [ [{foreach from=$oxajax.container1 item=aItem key=iKey}]
                                                      ...
                                                      [{/foreach}] ],
                                                    '[{$oViewConf->getAjaxLink()}]cmpid=container1&container=ciadminformmain&synchoxid=[{$oxid}]'
                                                    );
        ...
        YAHOO.oxid.container2 = new YAHOO.oxid.aoc( 'container2',
                                                    [ [{foreach from=$oxajax.container2 item=aItem key=iKey}]
                                                      ...
                                                      [{assign var="sSep" value=","}]
                                                      [{/foreach}] ],
                                                    '[{$oViewConf->getAjaxLink()}]cmpid=container2&container=ciadminformmain&oxid=[{$oxid}]'
                                                    )
        ...
        YAHOO.oxid.container2.subscribe( "rowClickEvent", function( oParam )
        {
            ...
            if ( aSelRows.length ) {
                ...
                $('form_element_3').value    = oParam._oData._3;
                $('form_element_4').value    = oParam._oData._4;
                $('form_element_5').value    = oParam._oData._5;
                $('form_element_6').value    = oParam._oData._6;
                $('form_element_7').value    = oParam._oData._7;
        ...
        YAHOO.oxid.container2.saveAttribute = function()
        {
            ...
            YAHOO.util.Connect.asyncRequest( 'GET', '[{$oViewConf->getAjaxLink()}]&cmpid=container2&container=ciadminformmain&fnc=saveAttributeValue&oxid=[{$oxid}]&attr_value=' + encodeURIComponent( $('attr_value').value ) + '&attr_oxid=' + encodeURIComponent( $('attr_oxid').value ), callback );
    ...
    <table width="100%">
        ...
        <tr>
            ...
            <td valign="top" align="left" class="edittext" id="arrt_conf" style="visibility:hidden">
              <br><br>
              ...
              <b>[{oxmultilang ident="FORMBUILDER_LABEL_OXSORT"}]</b><br><input id="form_element_7" class="editinput" type="text"><br><br>
